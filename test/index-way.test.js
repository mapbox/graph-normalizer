...
test('index-way', (t) => {
    ...
    deepEqual(Object.keys(r).length, 4, '4 tiles have segments');
    t.same(r, result);
    t.end();
});

test('index-way z13', (t) => {
    const r = indexWay(way, 13);
    deepEqual(Object.keys(r).length, 1, 'only one tile returned');
    const r2 = indexWay(wayZ13, 13);
    deepEqual(Object.keys(r2).length, 1, 'way in 2 z13 tiles.');
    t.end();
});
