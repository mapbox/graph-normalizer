  ...
  while (nodes.size) {
    ...
    if (validMerge) {
      ...
      if (options.mergeAccess) {
        if (opening.properties.hasOwnProperty('access')) combined.properties.access = opening.properties.access;
        else if (closing.properties.hasOwnProperty('access')) combined.properties.access = closing.properties.access;
      } else if (opening.properties.hasOwnProperty('access')) combined.properties.access = opening.properties.access;
